...
function paragenv7_pinetree(x, y, z, area, data)
	local c_pitree = minetest.get_content_id("default:pinetree")
...
minetest.register_abm({
	nodenames = {"paragenv7:acacialing"},
	interval = 33,
	chance = 5,
	action = function(pos, node)
		local x = pos.x
